...
var FacebookClient = require("./facebookClient").FacebookClient;

http.createServer(function (request, response) {
    var app_id = "358925717465400"; // configure like your fb app page states
    
    var facebook_client = new FacebookClient(
        app_id,
        "e568e17a644af01255c42c06aab4bcc5" // configure like your fb app page states
    );
        ...
        if (!facebook_session)
        {
            ...
            response.write([
                ...
                '<script type="text/javascript">',
                  ...
                  '    FB.init({appId: "' + app_id +'", logging:false, status: true, cookie: true, xfbml: true, oauth: true});',
